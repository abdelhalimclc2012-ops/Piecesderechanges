...
# icon.filename desactive : pas d'icon.png propre a cette app.
# Ajoute un fichier icon.png (512x512) a la racine du repo puis
# reactive la ligne ci-dessous si tu veux une icone personnalisee.
