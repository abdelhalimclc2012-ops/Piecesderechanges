...
fullscreen = 0
# icon.filename desactive : pas d'icon.png dans le repo pour l'instant.
# Ajoute un fichier icon.png (512x512 recommande) a la racine du repo
# puis reactive la ligne ci-dessous si tu veux une icone personnalisee.
